    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea  class="form-control form-control-sm @error('txtAddress') is-invalid @enderror" name="txtAddress" id="txtAddress" cols="30" rows="10" name="txtArea">  {{ old('txtAddress') }}</textarea>
                    @error('txtAddress')
                    <div class="invalid-feedback">
                    {{ $message }}
                    </div>
